...
class MatchListAdapter: ListAdapter<MatchInfo, MatchListAdapter.MatchViewHolder>(MatchInfoDiffCallBack()) {
    ...
    inner class MatchViewHolder(val binding: ViewDataBinding): RecyclerView.ViewHolder(binding.root)
    companion object {
